    ...
    <table class="table table-hover">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="view.html" class="icon pc-hidden"><i class="fas fa-user-tie"></i></a>
            <a href="view.html" class="utxt pc-hidden">홍길동 [2021.08.12]</a>
            <a href="view.html">제목입니다.</a>
          </td>
        ...
        <form>
          <div class="input-group">
            <div class="input-group-prepend">
              <button type="button" class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown">제목+내용</button>
              <div class="dropdown-menu">
                <a href="view.html" class="dropdown-item">이름</a>
                <a href="view.html" class="dropdown-item">제목</a>
                <a href="view.html" class="dropdown-item">내용</a>
                <a href="view.html" class="dropdown-item">제목+내용</a>
              </div>
            </div>
